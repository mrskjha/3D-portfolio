...
import webhealthchecker from "../assets/tech/webhealthchecker.png";
...
const projects = [
  ...
  
  {
    ...
    description:
      "WebHealthChecker is a web-based monitoring application that helps users track website uptime, performance, and availability in real time. It provides health status insights and automated alerts to detect downtime or performance issues early.",
    tags: [
      {
        name: "nextjs",
        color: "blue-text-gradient",
    ...
    image: webhealthchecker,
    source_code_link: "https://github.com/mrskjha/WebHealthChecker",
    live_link: "https://web-health-checker.vercel.app/",
  },
  {
