  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className="mt-5">
          <h3 className="text-white text-[20px] font-bold mt-5">{name}</h3>
...
const Works = () => {
  return (
    <>
      <motion.div variants={textVariant()} className="pl-2">
      ...
      <div className="w-full flex">
        <motion.p
          ...
          className="mt-3 pl-2 text-secondary text-[17px] max-w-3xl leading-[30px]"
        >
          Here are some of the projects I have worked on. You can find more
          projects on my GitHub profile.
        </motion.p>
      </div>
      <div className="mt-20 mx-10 my-4 flex flex-wrap gap-7">
